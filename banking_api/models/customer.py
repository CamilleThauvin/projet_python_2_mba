...
class CustomerProfile(BaseModel):
    ...
    fraudulent: bool = Field(..., description="Indique si le client a été impliqué dans une fraude")
...
class TopCustomer(BaseModel):
    ...
    avg_amount: float = Field(..., description="Montant moyen des transactions")
    fraud_count: int = Field(..., description="Nombre de fraudes")
    fraudulent: bool = Field(..., description="Indique si le client a commis des fraudes")
